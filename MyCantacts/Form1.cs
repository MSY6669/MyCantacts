    ...
    public partial class Form1 : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            if (dgContacts.CurrentRow!=null)
            {
                ...
                if (MessageBox.Show($"ایا از حذف {fullName} مطمئن هستید؟ ","توجه",MessageBoxButtons.YesNo,MessageBoxIcon.Warning)==DialogResult.Yes)
                {
            ...
            {
                MessageBox.Show("لطفا یک شخص را از لیست انتخاب کنید", "!خطا");
            }
        }
